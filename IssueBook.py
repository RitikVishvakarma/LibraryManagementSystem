...
bookTable = "books"
allBid = []  # Store all the Book ID's
...
def issue():
    ...
    updateStatus = f"update {bookTable} set status = 'issued' where id = '{bid}'"
...
def issueBook():
    ...
    headingLable = Label(headingFrame1, text="Delete Books", bg='black', fg='white', font=('Courier', 15))
    ...
    # Issue Button
    issueBtn = Button(root, text="Issue", bg='blue', fg='white', command=issue)
